...
- En el ejemplo de clase se trabaja con la especie Bombus affinis (abejorros), sin embargo, obtuve directamente la base de datos de [PREDICTS database](https://data.nhm.ac.uk/dataset/the-2016-release-of-the-predicts-database) y voy a trabajar con el género de hormigas [*Pheidole*,](https://es.wikipedia.org/wiki/Solenopsis) también conocida como hormiga colorada o de fuego.
